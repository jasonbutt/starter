...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiamFzb25idSIsImEiOiJja2tzZmp5cTMwOXh3Mm9zNGFrZ2ZtZzF4In0.C25Tf3oWx0KhQkslTYd4WA';
...
var stripe = Stripe('pk_test_51IKQqlHgd6geqCnm3Te6QIQu1nvecOH7M6nsRxxjWxgoGKSQlmMK8kQxqER4kBIFVEIu3EZSRVbrbw4hgAM1930R006LjbNcIK');
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 7:
              ...
              cdocument.getElementById('password-confirm').value = '';
